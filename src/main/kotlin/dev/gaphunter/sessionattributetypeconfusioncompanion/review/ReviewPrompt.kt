package dev.gaphunter.sessionattributetypeconfusioncompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.sessionattributetypeconfusioncompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.sessionattributetypeconfusioncompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "Session Attribute Type Confusion Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/34081-session-attribute-type-confusion-companion/reviews"
